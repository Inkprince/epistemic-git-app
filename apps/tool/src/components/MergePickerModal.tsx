...
interface MergeSource {
  ...
  label: string;
  bundle: Bundle;
  origin: "suggested" | "committed" | "imported";
}
...
export function MergePickerModal({
  ...
  return (
    <Modal onClose={onClose} ariaLabel="Merge a bundle into this case">
        <div className="head">
        ...
        <div className="merge-list">
          {sources.length === 0 && (
            <p className="note">Nothing to merge yet — import a ledger first (sidebar → Import ledger).</p>
          )}
          {sources.map((s) => {
              ...
              <div key={s.key} className="merge-row">
                ...
                <div className="mr-main">
                  ...
                  <div className="mr-sub">
                    {s.bundle.claims.length} claims · {s.bundle.inferences.length} inferences
                ...
                <div className="mr-side">
                  <Badge tone={s.origin === "suggested" ? "amber" : s.origin === "imported" ? "purple" : "neutral"}>
                    {s.origin}
                  </Badge>
                  <button
