...
competition, which asks how AI can help build trustworthy, inspectable knowledge bases about
contested questions. One of our worked cases is the 2008 argument that high-energy LHC collisions
posed no credible planetary risk from hypothetical microscopic black holes.

Rather than write an essay that argues a conclusion, we've built the safety argument as a structured,
inspectable record: each claim tied to an exact source passage, each reasoning step laid out with its
assumptions and the conditions that would break it, and each open to challenge on its own. The
sources include the LHC Safety Assessment Group review, the Giddings–Mangano astrophysical-bounds
paper, Hawking's original evaporation paper, the production-mechanism work, and two skeptic sources.
...
**Time.** About [90 minutes]. You'll get a one-page primer (attached), a short form with the named
targets, browser access to the record, and the cited sources. No software to install.
